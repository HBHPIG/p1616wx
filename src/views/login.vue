            ...
            <div class="cont_login" v-show="loginkg">
                ...
                <div class="login_form">
                    ...
                    <!--<div class="login_box"  v-show="type == 'phone'">-->
                        <!--<div class="input_box">
                           &lt;!&ndash; &lt;!&ndash;<input v-model="phoneName" class="input input_phone mobile" id="login_phone" type="text" placeholder="手机号" maxlength="11">&ndash;&gt;
                            <wv-input v-model="phoneName"  placeholder="手机号" maxlength="11" type="text"></wv-input>
                        </div>
                        <div class="input_box">
                        ...
                        <div>
                            <a href="javascript:void(0);" class="btn btn_login" id="login_by_phone" @click="phoneLogin">快速登录</a>&ndash;&gt;
                        </div>-->
                      <wv-group title="综合示例" >
